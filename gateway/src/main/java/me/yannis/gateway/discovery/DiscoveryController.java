package me.yannis.gateway.discovery;
...
public class DiscoveryController {
     ...
     */
    @GetMapping("/naming")
    public ResponseEntity<Map<String, Boolean>> getServerStatus(@RequestParam("serviceName") String serviceName) throws NacosException {
        List<Instance> allWebSocketInstances = namingService.getAllInstances(serviceName);
